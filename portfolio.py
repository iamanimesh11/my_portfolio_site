...
def show_home_page():
    ...
    st.markdown(
        "<h1 style='text-align: left;padding-top:50px;padding-bottom:100px ;color:#00ff99; margin :auto;' >My Skills:</h1>",
        unsafe_allow_html=True)
    ...
    Professional_column.markdown(
        "<h3 style='text-align: left;padding-top:40px;margin-left:10px;text-decoration: underline;' >Soft Skills:</h3>",
        unsafe_allow_html=True)
