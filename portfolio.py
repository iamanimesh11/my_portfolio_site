...
def show_home_page():
    ...
    st.markdown("<p style='margin-top: 30px;'>Navigate to <span style='background-color: yellow;'>My Projects</span> and <span style='background-color: yellow;'>Resume</span> on the left side</p>", unsafe_allow_html=True)
